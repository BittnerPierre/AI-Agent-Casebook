...
class KnowledgeEntry(BaseModel):
    ...
    last_uploaded_at: Optional[datetime] = Field(None, description="Dernière date d'upload vers OpenAI")
...
class UploadResult(BaseModel):
    ...
    reuse_count: int = Field(default=0, description="Nombre de fichiers réutilisés (déjà sur OpenAI)")
    attach_success_count: int = Field(default=0, description="Nombre de fichiers attachés avec succès")
