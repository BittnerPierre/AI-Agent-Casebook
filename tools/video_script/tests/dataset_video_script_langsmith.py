...
FILE_NAME = "dataset_video_script_simple.json"
DATASET_NAME = "VIDEO-SCRIPT-SIMPLE-datasets-29-01-2025"
DESCRIPTION = "Simple Dataset for testing video script assistant"
